...
class Penjualan_model extends CI_Model {
	...
	private function _get_datatables_query()
	{
		...
		$this->db->select('stt_penjualan, nama_lengkap, no_penjualan, kode_kavling, penjualan.id_penjualan, penjualan.booking_fee, no_telp, kavling_peta.id_kavling');
		...
		$this->db->where("penjualan.stt_penjualan = '$jenis'");
