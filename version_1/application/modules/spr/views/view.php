                ...
                <form action="#" id="form_pindah" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group row">
                            <label class="control-label col-md-3">Nomor SPR</label>
                            <div class="col-md-3">
                                <input name="no_spr_lama" id="no_spr_lama" class="form-control" type="text" value="">
                                <input name="nomor_spr" id="nomor_spr" class="form-control" type="text" value="<?=$notrx;?>">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input name="kode_kavling" id="kode_kavling" class="form-control" type="text" readonly>
                                <input name="id_kavling" id="id_kavling" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input name="harga_rumah_baru" id="harga_rumah_baru" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
