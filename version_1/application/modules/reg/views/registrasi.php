...
<section class="content">
      <div class="card">
        ...
        <!-- Foto Selfie -->
        <div class="form-group row">
            <label for="foto_calon_pemilik" class="col-sm-2 col-form-label">Foto Selfie</label>
            <div class="col-sm-10">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" id="booking_fee" name="booking_fee" value="2.220.000" required>
            </div>
        </div>
        ...
        <!-- Lokasi Kavling -->
        <div class="form-group row">
            <label for="lokasi_kavling" class="col-sm-2 col-form-label">Blok Unit Rumah</label>
            <div class="col-sm-3">
