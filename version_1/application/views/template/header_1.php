...
<head>
    ...
    <title>ARKHA KAVLING</title>
    <!-- Tell the browser to be responsive to screen width -->
    <meta name="viewport" content="width=device-width, initial-scale=1">


        <!-- Font Awesome -->   
        <link rel="icon" type="image/png" href="<?=base_url('assets/vavicon.png');?>"/>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?= base_url(); ?>" class="brand-link">
                <img src="<?=base_url('assets/vavicon.png')?>" alt="Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light"><strong>ARKHA KAVLING</strong></span>
            </a>
