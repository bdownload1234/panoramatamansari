                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                <input name="tipe_bangunan" placeholder="" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="control-label col-md-3">Status</label>
                            <div class="col-md-2">
                              <select class="form-control" name="stt_stok" >
                                <option value="0"> -- pilih --</option>
                                <option value="1">Hold</option>
                                <option value="2">Avaiable</option>
                                <option value="3">NUP</option>
                                <option value="4">Terboking</option>
                                <option value="5">Sudah Akad</option>
                                <option value="6">Standart</option>
                                <option value="7">Khusus</option>
                              </select>
                                <span class="help-block"></span>
                            </div>
                        </div>
