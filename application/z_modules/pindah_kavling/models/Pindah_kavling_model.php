...
class Pindah_kavling_model extends CI_Model {
	...
	var $order = array('spr.id_spr' => 'desc'); // default order 
	...
	private function _get_datatables_query()
	{
		...
		// $this->db->join('kavling_peta', 'kavling_peta.id_kavling = pindah_kavlingx.lokasi_baru', 'left');
