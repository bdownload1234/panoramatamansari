  ...
  <div class="content-wrapper">
      ...
      <div class="content-header">
          <div class="container-fluid">
              <div class="row mb-2">
                  <div class="col-sm-6">
                      <h1 class="m-0 text-dark">Data Keuangan NUP</h1>
                  </div><!-- /.col -->
                  <div class="col-sm-6">
                      <ol class="breadcrumb float-sm-right">
                          <li class="breadcrumb-item"><a href="<?php echo base_url('dashboard'); ?>">Home</a></li>
                          <li class="breadcrumb-item active">Keuangan NUP</li>
                      </ol>
                  </div><!-- /.col -->
              </div><!-- /.row -->
          </div><!-- /.container-fluid -->
      ...
      <?php
$jBook = $this->db->query("SELECT SUM(nominal) as jum FROM keuangan_nup")->row_array();
?>
      ...
      <section class="content">
          <div class="card">
              <div class="card-header">
                  <h3 class="card-title">Total Dana NUP : <b>Rp. <?=rupiah($jBook['jum']);?></b></h3>
                  <div class="card-tools">
                      <a href="<?=base_url('keuangan_nup/excel');?>" target="_blank" class="btn btn-info btn-sm" ><i class="fa fa-plus"></i> Import Data ke Excel</a>&nbsp;
