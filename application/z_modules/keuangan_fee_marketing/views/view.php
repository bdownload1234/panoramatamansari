  ...
  <div class="content-wrapper">
      ...
      <div class="content-header">
          <div class="container-fluid">
              <div class="row mb-2">
                  <div class="col-sm-6">
                      <h1 class="m-0 text-dark">Data Fee Marketing</h1>
                  </div><!-- /.col -->
                  <div class="col-sm-6">
                      <ol class="breadcrumb float-sm-right">
                          <li class="breadcrumb-item"><a href="<?php echo base_url('dashboard'); ?>">Home</a></li>
                          <li class="breadcrumb-item active">Keuangan Fee Marketing</li>
                      </ol>
                  </div><!-- /.col -->
              </div><!-- /.row -->
          </div><!-- /.container-fluid -->
      ...
      <section class="content">
          <div class="card">
              <div class="card-header">
                  <h3 class="card-title">Total Fee Marketing : Rp. </h3>
              ...
              <div class="card-body">
                  ...
                  <table id="table" class="table table-striped table-hover table-bordered" cellspacing="0"
                      ...
                      <thead>
                          <tr>
                              <th width="5%">No</th>
                              <th width="10%">Kode Marketing</th>
                              <th width="25%">Nama Marketing</th>
                              <th width="20%">Nama Agen</th>
                              <th width="15%">Jumlah Penjualan</th>
                              <th width="15%">Jumlah Fee</th>
  ...
  <script type="text/javascript">
      ...
      function detail_marketing(id) {
        $('#modal_form_detail').modal('show'); // show bootstrap modal
        $('#detailDisposisi').load('<?=base_url('keuangan_fee_marketing/ajax_detail_fee/');?>' + id);
      }
  ...
  <div class="modal fade" id="modal_form_detail" role="dialog">
      <div class="modal-dialog modal-lg">
          <div class="modal-content">
              <div class="modal-header">
                  <h3 class="modal-title">Detail Penjualan Markerting</h3>
              </div>
              <div class="modal-body form">
