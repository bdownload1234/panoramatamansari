    ...
    <section class="content">
      <div class="card">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <img src="<?=base_url('lampiran_registrasi/'.$reg['foto_ktp']);?>" alt="" height="100px">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <img src="<?=base_url('lampiran_registrasi/'.$reg['foto_npwp']);?>" alt="" height="100px">
            </div>
        </div>
        ...
        <!-- Foto KK -->
        <div class="form-group row">
            <label for="foto_kk" class="col-sm-3 col-form-label">Foto Kartu Keluarga</label>
            <div class="col-sm-10">
                <img src="<?=base_url('lampiran_registrasi/'.$reg['foto_kk']);?>" alt="" height="100px">
            </div>
        </div>
        ...
        <!-- Foto BPJS -->
        <div class="form-group row">
            <label for="foto_bpjs" class="col-sm-3 col-form-label">Foto BPJS</label>
            <div class="col-sm-10">
                <img src="<?=base_url('lampiran_registrasi/'.$reg['foto_bpjs']);?>" alt="" height="100px">
            </div>
        </div>

        <!-- Foto Selfie -->
        <div class="form-group row">
            <label for="foto_selfie" class="col-sm-3 col-form-label">Foto Selfie</label>
            <div class="col-sm-10">
                <img src="<?=base_url('lampiran_registrasi/'.$reg['foto_selfie']);?>" alt="" height="100px">
            </div>
        </div>

        <!-- Foto Customer -->
        <div class="form-group row">
            <label for="foto_customer" class="col-sm-3 col-form-label">Foto Customer</label>
            <div class="col-sm-10">
                <img src="<?=base_url('lampiran_registrasi/'.$reg['foto_customer']);?>" alt="" height="100px">
            </div>
        </div>
