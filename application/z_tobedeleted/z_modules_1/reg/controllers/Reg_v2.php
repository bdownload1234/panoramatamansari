...
class Reg extends CI_Controller {
   ...
   var $data_ref = array('uri_controllers' => 'customer');
	...
	public function ajax_add(){
		...
		$this->db->update('kavling_peta', ['stt_kavling'=> '1', 'nik' => $this->input->post('nik')], ['id_kavling' => $this->input->post('lokasi_kavling')]);
	...
	public function ajax_select_kavling(){
        ...
        $this->db->limit(20);
        $items=$this->db->get_where('kavling_peta', ['stt_kavling'=> '0'])->result_array();
