  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Data Pemesanan Rumah - Ganti Nama</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="card-header">
          <h3 class="card-title">Data Pembatalan</h3>
              <div class="card-tools">
                ...
                <a href="<?=base_url('/ganti_nama/download');?>" target="_blank" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> Download Data</a>&nbsp;
