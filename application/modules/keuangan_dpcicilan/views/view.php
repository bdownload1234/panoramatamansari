          ...
          <div class="card">
              <div class="card-header">
                  ...
                  <a href="#" onclick="add()" class="btn btn-warning btn-sm" ><i class="fa fa-plus"></i> Tambah Pembayaran</a>&nbsp;
                      <a href="<?=base_url('keuangan_dpcicilan/excel');?>" target="_blank" class="btn btn-info btn-sm" ><i class="fa fa-plus"></i> Download Data Excel</a>&nbsp;
                  ...
                  <form action="#" id="form" class="form-horizontal">
                      ...
                      <div class="form-body">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-4">
                                  <input name="model_rumah" id="model_rumah" class="form-control" type="text" readonly>
                                  <span class="help-block"></span>
                              </div>
                          </div>
  ...
  <script type="text/javascript">
    ...
    $('#nama_lengkap').on('change', function() {
      ...
      .done(function(data) {
        ...
        $('#tipe_rumah').val(data.tipe_bangunan);
        $('#model_rumah').val(data.model_rumah);
