      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-tools">
            <a href="<?=base_url('kavling/download');?>" target="_blank" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> Download Data</a>&nbsp;
                <a href="<?= base_url('kavling/upload');?>" class="btn btn-warning btn-sm""><i class="fa fa-plus"></i> Upload SVG</a></div>
             <!-- /.card-tools -->
        </div>
        <!-- /.card-header -->
        <div class="card-body">
           ...
           <table id="table" class="table table-striped table-hover table-bordered" cellspacing="0" width="100%">
                ...
                foreach($kavling as $kav){
                    if(strtoupper($query_user->jabatan) == 'PIC PUSAT' || strtoupper($query_user->jabatan) == 'DIREKTUR' || strtoupper($query_user->jabatan) == 'DIREKTUR UTAMA' || strtoupper($query_user->username) == 'AMEL'){
                        $row = '<td align="right">'.rupiah($kav->hrg_jual).'</td><td align="right">'.rupiah($kav->harga_jual_ajb).'</td><td align="right">'.rupiah($kav->harga_diskon).'</td>';
                    }else if(strtoupper($query_user->jabatan) == 'ADMIN'){
                        $row = '<td align="right">'.rupiah($kav->harga_diskon).'</td>';
                    }else{
                        $row = '';
                    }
        ...
        // 			}
        			...
        			$button = '';
        			if($kav->stt_kavling <> 4){
        			    $button = '<a class="btn btn-xs btn-success" href="javascript:void(0)" title="Edit" onclick="edit('."'".$kav->id_kavling."'".')"> Edit Kavling</a>';
        			}
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                            <select class="form-control" id="model_rumah" name="model_rumah" required>
                                <option>-</option>
                                <option value="Classic ( 37/60 )">Classic ( 37/60 )</option>
                                <option value="Classic ( 44/60 )">Classic ( 44/60 )</option>
                                <option value="Mezzanine ( 37+8/60 )">Mezzanine ( 37+8/60 )</option>
                                <option value="Mezzanine ( 44+8/60 )">Mezzanine ( 44+8/60 )</option>
                            </select>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div class="col-md-4">
                                <input name="booking_fee" id="booking_fee" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div class="col-md-4">
                                ...
                                <?php
                                    if(strtoupper($query_user->username) == 'AMEL'){
                                        echo 'disabled';
                                    }
                                ?>
                                >
                        ...
                        <div class="form-group row">
                            <label class="control-label col-md-3">Harga Jual AJB Cash</label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <select class="form-control" name="jenis_pembayaran" id="jenis_pembayaran" disabled>
                        ...
                        <div class="form-group row" 
                        <?php
                            if(strtoupper($query_user->jabatan) == 'PIC PUSAT' || strtoupper($query_user->jabatan) == 'DIREKTUR' || strtoupper($query_user->jabatan) == 'DIREKTUR UTAMA' || strtoupper($query_user->jabatan) == 'ADMIN' || strtoupper($query_user->username) == 'AMEL'){
                                echo '';
                            }else{
                                echo 'style="display: none"';
                            }
                        ?>
                        >
                            <label class="control-label col-md-3">Diskon Lainnya</label>
                            <div class="col-md-4">
       ...
       $.ajax({
           ...
           success: function(data)
           {
            ...
            //    $('[name="status"]').val(data.status);
               ...
               $('[name="jenis_pembayaran"]').val(data.jenis_bayar);
               $('[name="model_rumah"]').val(data.model_rumah);
               $('[name="harga_jual_ajb"]').val(data.harga_jual_ajb);
...
var booking_fee = document.getElementById('booking_fee');
