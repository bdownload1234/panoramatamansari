  ...
  <div class="content-wrapper">
      ...
      <div class="content-header">
          <div class="container-fluid">
              <div class="row mb-2">
                  <div class="col-sm-6">
                      <h1 class="m-0 text-dark">Data Pajak Booking</h1>
                  </div><!-- /.col -->
                  <div class="col-sm-6">
                      <ol class="breadcrumb float-sm-right">
                          <li class="breadcrumb-item"><a href="<?php echo base_url('dashboard'); ?>">Home</a></li>
                          <li class="breadcrumb-item active">Pajak Booking</li>
                      </ol>
                  </div><!-- /.col -->
              </div><!-- /.row -->
          </div><!-- /.container-fluid -->
      ...
      <section class="content">
          <div class="card">
              <div class="card-header">
                  <h3 class="card-title">Data Pajak Booking</h3>
              ...
              <div class="card-body">
                  ...
                  <table id="table" class="table table-striped table-hover table-bordered" cellspacing="0"
                      ...
                      <thead>
                          <tr>
                              <th width="5%">No</th>
                              <th width="20%">ID Billing Booking</th>
                              <th width="20%">Blok Kavling</th>
                              <th width="20%">NTPN Booking</th>
                              <th width="20%">Nomor Seri Pajak Booking</th>
                              <th width="15%">Lampiran Pajak Booking</th>
                  ...
                  <form action="#" id="form" class="form-horizontal">
                      ...
                      <div class="form-body">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-3">
                                  <input name="blok_kavling" id="blok_kavling" class="form-control" type="text"
                                      value="">
                                  <span class="help-block"></span>
                              </div>
                          </div>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-3">
                                  <input name="nama_customer" id="nama_customer" class="form-control" type="text" readonly>
                                  <span class="help-block"></span>
                              </div>
                          </div>
                          
                          <div class="form-group row">
                              <label class="control-label col-md-3">NPWP Customer</label>
                              <div class="col-md-3">
                                  <input name="npwp_customer" id="npwp_customer" class="form-control" type="text" readonly>
                                  <span class="help-block"></span>
                              </div>
                          </div>
                          
                          <div class="form-group row">
                              <label class="control-label col-md-3">Alamat Customer</label>
                              <div class="col-md-7">
                                  <input name="alamat_customer" id="alamat_customer" class="form-control" type="text" readonly>
                                  <span class="help-block"></span>
                              </div>
                          </div>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-3">
                                  <input name="nama_marketing" id="nama_marketing" class="form-control" type="text" readonly>
                                  <span class="help-block"></span>
                              </div>
                          </div>
                          
                          <div class="form-group row">
                              <label class="control-label col-md-3">NPWP Marketing</label>
                              <div class="col-md-3">
                                  <input name="npwp_marketing" id="npwp_marketing" class="form-control" type="text" readonly>
                                  <span class="help-block"></span>
                              </div>
                          </div>
                          
                          <div class="form-group row">
                              <label class="control-label col-md-3">Alamat Marketing</label>
                              <div class="col-md-7">
                                  <input name="alamat_marketing" id="alamat_marketing" class="form-control" type="text" readonly>
                                  <span class="help-block"></span>
                              </div>
                          </div>
                          ...
                          <div class="form-group row">
                              <label class="control-label col-md-3">NTPN Booking</label>
                              <div class="col-md-3">
                          ...
                          <div class="form-group row">
                              <label class="control-label col-md-3">No Seri Pajak Booking</label>
                              <div class="col-md-3">
                                  <input name="no_seri_booking" id="no_seri_booking" class="form-control"
                                      type="text">
                                  <span class="help-block"></span>
                              </div>
                          </div>
                          ...
                          <div class="form-group row">
                              <label class="control-label col-md-3">Lampiran Pajak Booking</label>
                              <div class="col-md-7">
                                  <input name="lampiran_booking" id="lampiran_booking" type="file">
                                  <span class="help-block"></span>
                              </div>
                          </div>
  ...
  <script type="text/javascript">
      ...
      function add() {
          ...
          $('.modal-title').text('Form Pajak Booking'); // Set Title to Bootstrap modal title
      }
      ...
      function edit(id) {
          ...
          $.ajax({
              ...
              success: function(data) {
                  ...
                  $('[name="NTPN"]').val(data.NTPN);
                  $('[name="no_seri_booking"]').val(data.no_seri_booking);
                  $('[name="keterangan"]').val(data.keterangan);
                  $('[name="status"]').val(data.status);
                  
                  $('[name="blok_kavling"]').select2('data', { id:data.id_kavling, text: data.kode_kavling}).trigger('change');
      ...
      function lampiran_1(idPajak) {
          $('#lampiran').modal('show');
          $('#detailLampiran').load('<?= base_url('pajakbooking/view_lampiran/') ?>' + idPajak);
      };

      function lampiran_2(idPajak) {
          $('#lampiran').modal('show');
          $('#detailLampiran').load('<?= base_url('pajakbooking/view_lampiran_2/') ?>' + idPajak);
      };
      
      $("#blok_kavling").select2({
        ajax: {
          url: url_apps+'pajakakad/ajax_select_blok_kavling',
          dataType: 'json',
          delay: 250,
      ...
      $('#blok_kavling').on('change', function() {
          $.ajax({
            url: url_apps + 'pajakbooking/get_data_blok_kavling/' + $(this).val(),
            type: 'GET',
            dataType: 'json',
          })
          .done(function(data) {
            $('#nama_customer').val(data.nama_lengkap);
            $('#npwp_customer').val(data.npwp_customer);
            $('#alamat_customer').val(data.alamat);
            $('#nama_marketing').val(data.nama_marketing);
            $('#npwp_marketing').val(data.npwp_marketing);
