...
class Pajakbooking extends CI_Controller
{
    ...
    public function ajax_edit($id)
    {
        ...
        $this->db->select('pajak_booking.*, kavling_peta.kode_kavling');
        $this->db->from('pajak_booking');
        $this->db->join('kavling_peta', 'pajak_booking.id_kavling = kavling_peta.id_kavling', 'left');
        $this->db->where('pajak_booking.id_pajak', $id);
        $query = $this->db->get();
        $data = $query->row();
    ...
    public function get_data_blok_kavling($id){
        ...
        $this->db->join('marketing', 'customer.nama_marketing = marketing.nama_marketing', 'left');
