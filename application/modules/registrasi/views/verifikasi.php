  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="card">
        ...
        <div class="form-group row">
            <label for="no_telp_saudara" class="col-sm-3 col-form-label">Hubungan Saudara</label>
            <div class="col-sm-4">
                <input type="text" class="form-control" id="hubungan_saudara" name="hubungan_saudara"  value="<?=$reg['hubungan_saudara'];?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                ...
                <input type="hidden" class="form-control" id="id_marketing" name="id_marketing"  value="<?=$reg['id_marketing'];?>">
            </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="form-group row">
            <label class="col-sm-3 control-label">NUP / SPR</label>
            <div class="col-md-3">
              <select name="nup_spr" id="nup_spr"  class="form-control">
                <option <?php if ($reg['nup_spr'] == '0') echo 'selected'; ?> value="0">NUP</option>
                <option <?php if ($reg['nup_spr'] == '1') echo 'selected'; ?> value="1">SPR</option>
              </select>
              <span class="help-block"></span>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-3">
                <select class="form-control" id="status_kavling" name="status_kavling">
                    ...
                    <option <?php if ($reg['stt_kavling'] == '1') echo 'selected'; ?> value="1">AVAILABLE</option>
