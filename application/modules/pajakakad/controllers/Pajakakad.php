...
class Pajakakad extends CI_Controller
{
    ...
    public function ajax_edit($id)
    {
        ...
        $this->db->select('pajak_akad.*, kavling_peta.kode_kavling');
        $this->db->from('pajak_akad');
        $this->db->join('kavling_peta', 'pajak_akad.id_kavling = kavling_peta.id_kavling', 'left');
        $this->db->where('pajak_akad.id_pajak', $id);
        $query = $this->db->get();
        $data = $query->row();
    ...
    public function ajax_add()
    {
        $data = [
            ...
            'id_kavling' => $this->input->post('blok_kavling'),
    ...
    public function ajax_select_blok_kavling(){
    ...
    public function get_data_blok_kavling($id){
        $this->db->select('customer.nama_lengkap, customer.npwp as npwp_customer, customer.alamat, marketing.nama_marketing, marketing.npwp as npwp_marketing, marketing.alamat_marketing');
        $this->db->from('customer');
        $this->db->join('marketing', 'customer.id_marketing = marketing.id_marketing', 'left');
        $this->db->where('customer.id_kavling', $id);
        $query = $this->db->get();
