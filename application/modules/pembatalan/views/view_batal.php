  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Data Penjualan Rumah - (BATAL)</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Data Penjualan</h3>
              ...
              <a href="<?=base_url('/pembatalan/download');?>" target="_blank" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> Download Data</a>&nbsp;
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input name="tanggal_pembatalan" id="tanggal_pembatalan" class="form-control" type="date" value="<?=date('Y-m-d');?>">
                        ...
                        <div class="form-group row">
                            <label class="control-label col-md-3">Keterangan Pembatalan</label>
                            <div class="col-md-7">
                                <input name="keterangan_pembatalan" id="keterangan_pembatalan" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
      ...
      table = $('#table').DataTable({
          ...
          "ajax": {
              "url": url + "<?php echo $data_ref['uri_controllers']; ?>/ajax_list/3",
              "type": "POST"
          },
  ...
  $("#nama_lengkap").select2({
    ajax: {
      url: url_apps+'spr/ajax_select_pembatalan',
      dataType: 'json',
      delay: 250,
