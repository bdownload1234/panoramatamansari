  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="card">
        ...
        <!-- Tipe Unit -->
        <div class="form-group row">
            <label for="lokasi_kavling" class="col-sm-3 col-form-label">Tipe Bangunan</label>
            <div class="col-sm-3">
                <!-- <input type="text" class="form-control" id="lokasi_kavling" name="lokasi_kavling"> -->
                <input type="text" class="form-control" id="tipe_unit" name="tipe_unit" value="<?=$reg['tipe_bangunan'];?>" readonly>
            </div>
        </div>
        
        <!-- Tipe Unit -->
        <div class="form-group row">
            <label for="lokasi_kavling" class="col-sm-3 col-form-label">Model Rumah</label>
            <div class="col-sm-3">
                <!-- <input type="text" class="form-control" id="lokasi_kavling" name="lokasi_kavling"> -->
                <input type="text" class="form-control" id="model_rumah" name="model_rumah" value="<?=$reg['model_rumah'];?>" readonly>
            </div>
        </div>
