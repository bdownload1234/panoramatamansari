...
<section class="content">
      <div class="card">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="file" class="form-control-file" id="bukti_transfer" name="bukti_transfer" accept="image/*" capture="camera" />
            </div>
        </div>
...
$(document).ready(function() {
    $('#foto_ktp_suami').on('change', function() {
        ...
        $.ajax({
            url: linkurl + 'reg/upload_image_method', // Sesuaikan dengan URL route yang Anda tentukan
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
