        ...
        <div class="card-header">
          <h3 class="card-title">Data Customer</h3>
              <div class="card-tools">
                <a href="<?=base_url('customer/download');?>" target="_blank" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> Download Data</a>&nbsp;
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input name="kode_customer" value="" class="form-control" type="text" readonly>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input name="alamat_domisili" placeholder="" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input name="no_wa" placeholder="" class="form-control" type="no_wa">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input name="no_hp_tidak_serumah" placeholder="" class="form-control" type="no_hp_tidak_serumah">
                                <span class="help-block"></span>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label class="control-label col-md-3">Alamat Keluarga tidak serumah</label>
                            <div class="col-md-7">
                                <input name="alamat_tidak_serumah" placeholder="" class="form-control" type="alamat_tidak_serumah">
                                <span class="help-block"></span>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label class="control-label col-md-3">Nama Refferal</label>
                            <div class="col-md-3">
                                <select class="form-control" name="marketing" id="marketing">
                                    ...
                                    foreach($marketing as $mrk){
                                        echo '<option value="'.$mrk->id_marketing.'">'.$mrk->kode_marketing.' # '.$mrk->nama_marketing.'</option>';
                                    }
                                    ?>
                                </select>
                                <span class="help-block"></span>
                        ...
                        <div class="form-group row">
                            <label class="control-label col-md-3">Foto Ttd Pembeli</label>
                            <div class="col-md-6">
   ...
   function edit(id)
   {
       ...
       $.ajax({
           ...
           success: function(data)
           {
               ...
               $('[name="alamat_tidak_serumah"]').val(data.alamat_tidak_serumah);
               $('[name="tempat_lahir"]').val(data.tempat_lahir);
               $('[name="tgl_lahir"]').val(data.tgl_lahir);
               $('[name="jenis_kelamin"]').val(data.jenis_kelamin);
               $('[name="no_telp"]').val(data.no_telp);
               $('[name="no_wa"]').val(data.no_wa);
               $('[name="no_hp_tidak_serumah"]').val(data.no_hp_tidak_serumah);
