  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="card">
        ...
        <!-- Tipe Unit -->
        <div class="form-group row">
            <label for="tipe_unit" class="col-sm-3 col-form-label">Tipe Bangunan</label>
            <div class="col-sm-3">
            <input type="text" class="form-control" id="tipe_unit" name="tipe_unit"  value="<?=$cust['tipe_bangunan'];?>" readonly>
        ...
        <!-- Model RUmah -->
        <div class="form-group row">
            <label for="tipe_unit" class="col-sm-3 col-form-label">Model Rumah</label>
            <div class="col-sm-3">
            <input type="text" class="form-control" id="model_rumah" name="model_rumah"  value="<?=$cust['model_rumah'];?>" readonly>
            </div>
        </div>
            ...
            <div class="col-lg-5">
                <div class="row">
                    <div class="col-lg-4">
                        <h6>FOTO KTP 
                        <br>
                        <a href="<?=base_url('customer/lampiran/'.$cust['foto_ktp']);?>" target="_blank" class="btn btn-info btn-xs"> Download</a></h6>
                    ...
                    <div class="col-lg-4">
                        <h6>FOTO NPWP <br>
                        <a href="<?=base_url('customer/lampiran/'.$cust['foto_npwp']);?>" target="_blank" class="btn btn-info btn-xs"> Download</a></h6>
                        <img src="<?=base_url('lampiran_registrasi/'.$cust['foto_npwp']);?>" alt="" width="100%">
                    </div>

                    <div class="col-lg-4">
                        <h6>FOTO KK <br>
                        <a href="<?=base_url('customer/lampiran/'.$cust['foto_kk']);?>" target="_blank" class="btn btn-info btn-xs"> Download</a></h6>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <h6>FOTO BPJS <br>
                        <a href="<?=base_url('customer/lampiran/'.$cust['foto_bpjs']);?>" target="_blank" class="btn btn-info btn-xs"> Download</a></h6>
                    ...
                    <div class="col-lg-4">
                        <h6>FOTO PASANGAN <br>
                        <a href="<?=base_url('customer/lampiran/'.$cust['foto_ktp_istri']);?>" target="_blank" class="btn btn-info btn-xs"> Download</a></h6>
                        <img src="<?=base_url('lampiran_registrasi/'.$cust['foto_ktp_istri']);?>" alt="" width="100%">
                    </div>

                    <div class="col-lg-4">
                        <h6>CALON PEMILIK <br>
                        <a href="<?=base_url('customer/lampiran/'.$cust['foto_calon_pemilik']);?>" target="_blank" class="btn btn-info btn-xs"> Download</a></h6>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <h6>BUKTI TRANSFER <br>
                        <a href="<?=base_url('customer/lampiran/'.$cust['bukti_transfer']);?>" target="_blank" class="btn btn-info btn-xs"> Download</a></h6>
