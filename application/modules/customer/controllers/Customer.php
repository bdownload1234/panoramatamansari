...
class Customer extends CI_Controller {
   ...
   var $data_ref = array('uri_controllers' => 'customer');
	...
	public function edit($idCustomer)
	{
		...
		->join('kavling_peta', 'kavling_peta.kode_kavling = customer.lokasi_kavling', 'left')
...
// 			if($post->status_customer == '1'){
// 				$row[] = 'VERIFIKASI';
// 			}else if($post->status_customer == '2'){
// 				$row[] = 'PROSES SPR';
// 			}else if($post->status_customer == '3'){
// 				$row[] = 'PROSES AKAD';
// 			}else if($post->status_customer == '4'){
// 				$row[] = 'SERAH TERIMA';
// 			}else if($post->status_customer == '5'){
// 				$row[] = 'PROSES NUP';
// 			}else if($post->status_customer == '6'){
// 				$row[] = 'PENDING';
// 			}
	...
	public function get($idCust){
        ...
        $item = $this->db->query("SELECT a.*, b.tipe_bangunan, b.model_rumah FROM customer a LEFT JOIN kavling_peta b ON a.id_kavling = b.id_kavling WHERE a.id_customer ='$idCust' ")->row_array();
