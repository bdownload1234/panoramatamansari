  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Data Pemesanan NUP</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
       ...
       function batal(id){
            $.confirm({
              ...
              buttons: {
                confirm: function () {
                   $.ajax({
                      url : url + "<?php echo $data_ref['uri_controllers']; ?>/ajax_batal/" + id,
                      type: "POST",
                      dataType: "JSON",
        ...
        function buat_spr(id){
            $.confirm({
              ...
              buttons: {
                confirm: function () {
                   $.ajax({
                      url : url + "<?php echo $data_ref['uri_controllers']; ?>/buat_spr/" + id,
                      type: "POST",
                      dataType: "JSON",
                      success: function(data)
                      {
