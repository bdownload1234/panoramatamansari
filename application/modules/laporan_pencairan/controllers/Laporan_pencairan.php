...
class Laporan_pencairan extends CI_Controller {

   var $data_ref = array('uri_controllers' => 'laporan_pencairan');

	public function __construct()
	{
		parent::__construct();
		$this->load->model('Laporan_pencairan_model','keuangan_pencairan');
	...
	public function proses()
	{
		...
		$user_data['data'] = $this->db->query("SELECT a.*, b.nama_lengkap, c.nama_bank FROM keuangan_pencairan a 
            JOIN customer b ON b.id_customer = a.id_customer
            JOIN bank c ON c.id_bank = a.id_bank
            WHERE a.tanggal >= '$tgl_awal' AND a.tanggal <= '$tgl_akhir'")->result();
