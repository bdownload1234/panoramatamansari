  ...
  <div class="content-wrapper">
      ...
      <div class="content-header">
          <div class="container-fluid">
              <div class="row mb-2">
                  <div class="col-sm-6">
                      <h1 class="m-0 text-dark">Data Bank</h1>
                  </div><!-- /.col -->
                  <div class="col-sm-6">
                  ...
                  <form action="#" id="form" class="form-horizontal">
                      ...
                      <div class="form-body">
                          ...
                          <div class="form-group row" style="display: none">
                              ...
                              <div class="col-md-4">
                                  <input name="kode_bank" id="kode_bank" class="form-control" type="text">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <input name="nama_bank" id="nama_bank" class="form-control" type="text">
                                  <span class="help-block"></span>
                              </div>
                          </div>

                          <div class="form-group row" style="display: none">
                              <label class="control-label col-md-3">Bunga per Tahun</label>
                              <div class="col-md-6">
                                  <input name="bunga_pertahun" id="bunga_pertahun" class="form-control" type="text">
                                  <span class="help-block"></span>
                              </div>
                          </div>
                          ...
                          <div class="form-group row" style="display: none">
                              ...
                              <div class="col-md-6">
                                  <input name="tenor" id="tenor" class="form-control" type="text">
                                  <span class="help-block"></span>
                              </div>
                          </div>
                          ...
                          <div class="form-group row" style="display: none">
                              ...
                              <div class="col-md-6">
                                  <input name="no_rekening" id="no_rekening" class="form-control" type="no_telp">
                                  <span class="help-block"></span>
                              </div>
                          </div>
                          ...
                          <div class="form-group row" style="display: none">
                              ...
                              <div class="col-md-6">
                                  <input name="nama_pemilik" id="nama_pemilik" type="text" class="form-control">
                                  <span class="help-block"></span>
                              </div>
                          </div>

                          <div class="form-group row" style="display: none">
                              <label class="control-label col-md-3">Virtual Account Bank </label>
                              <div class="col-md-6">
                                  <input name="v_account_bank" id="v_account_bank" type="text"
                                      class="form-control">
                                  <span class="help-block"></span>
                              </div>
                          </div>
                          ...
                          <div class="form-group row">
                              <label class="control-label col-md-3">Alamat Bank </label>
                              <div class="col-md-6">
                                  <textarea name="alamat_bank" id="alamat_bank"
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <input name="no_telp" id="no_telp" type="text" maxlength="13"
                                      class="form-control">
                                  <span class="help-block"></span>
                              </div>
                          </div>
      ...
      function edit(id) {
          ...
          $.ajax({
              ...
              success: function(data) {
                  ...
                  $('[name="kode_bank"]').val(data.kode_bank);
                  $('[name="nama_bank"]').val(data.nama_bank);
                  $('[name="bunga_pertahun"]').val(data.bunga_pertahun);
                  $('[name="tenor"]').val(data.tenor);
                  $('[name="no_rekening"]').val(data.norekening);
                  $('[name="nama_pemilik"]').val(data.nama_pemilik);
                  $('[name="v_account_bank"]').val(data.v_account_bank);
                  $('[name="alamat_bank"]').val(data.alamat_bank);
