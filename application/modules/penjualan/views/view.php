  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Data Dokumen AJB</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="card-header">
          <h3 class="card-title">Data Akad</h3>
              <div class="card-tools">
                <!--<a href="#" class="btn btn-info btn-sm" onclick="add()"><i class="fa fa-plus"></i> Proses AJB</a>&nbsp;-->
           ...
           <table id="table" class="table table-striped table-hover table-bordered" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th width="10%">Nomor AJB</th>
                        <th width="10%">Lampiran SJB</th>
