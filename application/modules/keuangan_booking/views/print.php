...
<body>
    <div class="container">
        ...
        <section class="details">
            <h4><strong>Nama Konsumen:</strong> <?= $keuangan_booking->nama_lengkap ?></h4>
            <table class="details-table">
                <tr>
                    <th class="underline" width="20%">Rp. <?= rupiah($keuangan_booking->nominal) ?></th>
                    <th style="text-align: left;" width="80%">Terbilang : <?= ucwords(terbilang($keuangan_booking->nominal)) ?> Rupiah</th>
                </tr>
            </table>
        </section>
        ...
        <footer>
            <table class="details-table">
                <tr>
                    <th width="70%"></th>
                    <th width="30%">Total : Rp <?= rupiah($keuangan_booking->nominal) ?></th>
                </tr>
            </table>
