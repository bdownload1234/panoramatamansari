  ...
  <div class="content-wrapper">
      ...
      <div class="content-header">
          <div class="container-fluid">
              <div class="row mb-2">
                  <div class="col-sm-6">
                      <h1 class="m-0 text-dark">Data Keuangan Booking</h1>
                  </div><!-- /.col -->
                  <div class="col-sm-6">
...
<?php
$jBook = $this->db->query("SELECT SUM(nominal) as jum FROM keuangan_booking")->row_array();
?>
      ...
      <section class="content">
          <div class="card">
              <div class="card-header">
                  <h3 class="card-title">Total Dana Booking : <b>Rp. <?=rupiah($jBook['jum']);?></b></h3>
                  <div class="card-tools">
                      <a href="<?=base_url('keuangan_booking/excel');?>" target="_blank" class="btn btn-info btn-sm" ><i class="fa fa-plus"></i> Download Data Excel</a>&nbsp;
                  ...
                  <table id="table" class="table table-striped table-hover table-bordered" cellspacing="0"
                      ...
                      <thead>
                          <tr>
                              ...
                              <th width="15%">Type Rumah</th>
                              <th width="15%">Model Rumah</th>
  ...
  <script type="text/javascript">
      ...
      function print(id) {
          window.open(url_apps + 'keuangan_booking/print/' + id, '_blank');
      }
