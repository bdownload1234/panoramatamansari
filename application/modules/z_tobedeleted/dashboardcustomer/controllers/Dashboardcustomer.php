...
class Dashboardcustomer extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('template_cust/header',$data);
		$this->load->view('dashboardcust',$data);
		$this->load->view('template_cust/footer',$data);
	}
	...
	public function ajax_edit($id)
	{
		$data = $this->db->query("SELECT * FROM kavling_peta a 
			...
			LEFT JOIN marketing m ON a.id_marketing=m.id_marketing 
