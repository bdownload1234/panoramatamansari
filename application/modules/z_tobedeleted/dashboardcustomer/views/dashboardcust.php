...
viewBox="0 0 7070 8804"
 ...
 <defs>
  ...
  if($cekCust['status_customer'] >= 1){ $proses2 = 'fil5'; }else{ $proses2 = 'fil1'; }
  if($cekCust['status_customer'] >= 2){ $proses3 = 'fil5'; }else{ $proses3 = 'fil1'; }
  if($cekCust['status_customer'] >= 3){ $proses4 = 'fil5'; }else{ $proses4 = 'fil1'; }
?>
