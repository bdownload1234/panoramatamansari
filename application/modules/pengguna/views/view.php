    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="#" id="form" class="form-horizontal">
          ...
          <div class="form-group row">
            <label class="col-sm-3 control-label">No WhatsApp</label>
            <div class="col-md-5">
          ...
          <div class="form-group row">
            <label class="col-sm-3 control-label">Kirim Notif</label>
              <div class="col-sm-3">
              <select name="kirim_notif" class="form-control" id="kirim_notif">
                <option>- pilih -</option>
          ...
          <div class="form-group row">
            <label class="col-sm-3 control-label">Status Admin</label>
              <div class="col-sm-3">
              <select name="is_admin" class="form-control" id="is_admin">
                <option>- pilih -</option>
                <option value="0">Direktur Utama</option>
                <option value="1">Admin Panorama</option>
                <option value="2">Admin KPR</option>
                <option value="3">PIC Pusat</option>
                <option value="4">PIC Lapangan</option>
                <option value="5">Admin Keuangan</option>
                <option value="6">Admin Pajak</option>
              </select>
            </div>
          </div>
   ...
   function edit(id)
   {
       ...
       $.ajax({
           ...
           success: function(data)
           {
               ...
               $('[name="kirim_notif"]').val(data.kirim_notif);
