  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Data Dokumen PPJB</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
           ...
           <table id="table" class="table table-striped table-hover table-bordered" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th width="10%">Nomor PPJB</th>
                        <th width="10%">Lampiran PPJB</th>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input name="nomor_ppjb" id="nomor_ppjb" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input name="file_ppjb" id="file_ppjb" type="file" value="">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input name="catatan_ppjb" id="catatan_ppjb" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
   ...
   function edit(id)
   {
       ...
       $.ajax({
           ...
           success: function(data)
           {
               ...
               $('[name="tanggal_ppjb"]').val(data.tanggal_ppjb);
               $('[name="nomor_ppjb"]').val(data.nomor_ppjb);
               $('[name="catatan_ppjb"]').val(data.catatan_ppjb);
               

               $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
               $('.modal-title').text('Update Data PPJB'); // Set title to Bootstrap modal title
