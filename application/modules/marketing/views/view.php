  ...
  <div class="content-wrapper">
      ...
      <div class="content-header">
          <div class="container-fluid">
              <div class="row mb-2">
                  <div class="col-sm-6">
                      <h1 class="m-0 text-dark">Data Marketing</h1>
                  </div><!-- /.col -->
                  <div class="col-sm-6">
      ...
      <section class="content">
          <div class="card">
              <div class="card-header">
                  ...
                  <a href="<?=base_url('marketing/download');?>" target="_blank" class="btn btn-warning btn-sm"><i class="fa fa-plus"></i> Download Data</a>&nbsp;
                      <a href="#" class="btn btn-info btn-sm" onclick="add()"><i class="fa fa-plus"></i> Tambah Marketing</a>&nbsp;
                ...
                <div class="table-responsive">
                  <table id="table" class="table table-striped table-hover table-bordered" cellspacing="0"
                      ...
                      <thead>
                          <tr>
                              <th width="5%">No</th>
                              <th width="8%">ID KODE AGEN</th>
                              <th width="8%">FOTO MARKETING</th>
                              <th width="17%">NAMA MARKETING</th>
                              ...
                              <th>NPWP</th>
                              <th>FILE NPWP</th>
                              <th>PERSENTASE FEE MARKETING</th>
                  ...
                  <form action="#" id="form" class="form-horizontal">
                      ...
                      <div class="form-body">
                          ...
                          <div class="form-group row">
                              <label class="control-label col-md-3">ID Kode Agen</label>
                              <div class="col-md-4">
                                  <input name="kode_marketing" placeholder="" class="form-control" type="text">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <input name="nama_agen" id="nama_agen" class="form-control" type="text">
                                  <span class="help-block"></span>
                              </div>
                          </div>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <input name="foto" placeholder="" type="file">
                                  <span class="help-block"></span>
                              </div>
                          </div>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <input name="nik" placeholder="" class="form-control" type="text" maxlength="16">
                                  <span class="help-block"></span>
                              </div>
                          </div>
                          ...
                          <div class="form-group row">
                              <label class="control-label col-md-3">Upload NPWP </label>
                              <div class="col-md-6">
                                  <input name="doc_npwp" placeholder="" type="file">
                                  <span class="help-block"></span>
                              </div>
                          </div>
                          
                          <div class="form-group row">
                              <label class="control-label col-md-3">Persentase Fee Marketing </label>
                              <div class="col-md-6">
                                  <input name="persentase_fee_marketing" placeholder="" class="form-control" type="text">
                                  <span class="help-block"></span>
                              </div>
                          </div>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <input name="harga_jual_ajb" placeholder="" id="harga_jual_ajb" class="form-control" type="text">
                                  <span class="help-block"></span>
                              </div>
                          </div>
  ...
  <script type="text/javascript">
      ...
      function add() {
          ...
          $('.modal-title').text('Tambah marketing'); // Set Title to Bootstrap modal title
      }
      ...
      function edit(id) {
          ...
          $('.help-block').empty(); // clear error string
          $('#modal_form').modal('show'); // show bootstrap modal
          $('.modal-title').text('Edit marketing'); // Set Title to Bootstrap modal title
          ...
          $.ajax({
              ...
              success: function(data) {
                  ...
                  $('[name="alamat"]').val(data.alamat_marketing);
                  $('[name="jenis_kelamin"]').val(data.jenis_kelamin);
                  $('[name="no_telp"]').val(data.no_telp_marketing);
                  $('[name="nik"]').val(data.nik);
                  $('[name="npwp"]').val(data.npwp);
                  $('[name="persentase_fee_marketing"]').val(data.persentase_fee_marketing);
