  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Data Pemesanan Rumah SPR</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="card-header">
          <h3 class="card-title">Data SPR</h3>
              <div class="card-tools">
                ...
                <a href="<?=base_url('/spr/download');?>" target="_blank" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> Download Data</a>&nbsp;
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input name="nama_lengkapx" id="nama_lengkapx" class="form-control" type="text" readonly>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="control-label col-md-3">Hubungan Saudara</label>
                            <div class="col-md-7">
                                <input name="hubungan_saudara" id="hubungan_saudara" class="form-control" type="text" readonly>
                                <span class="help-block"></span>
                            </div>
                        </div>
   ...
   function edit(id)
   {
       ...
       $.ajax({
           ...
           success: function(data)
           {
               ...
               $('[name="nama_lengkapx"]').val(data.nama_lengkap);
               $('[name="nomor_spr"]').val(data.nomor_spr);
               $('[name="no_ktp"]').val(data.nik);
               $('[name="alamat"]').val(data.alamat_rumah);
               $('[name="catatan"]').val(data.catatan);
               $('[name="no_telp"]').val(data.no_telp);
               $('[name="nama_saudara"]').val(data.nama_keluarga);
               $('[name="hubungan_saudara"]').val(data.hubungan_keluarga);
               $('[name="no_hp_tidak_serumah"]').val(data.no_telp_keluarga);
   ...
   function pindah(id)
   {
       ...
       $.ajax({
           ...
           success: function(data)
           {
            ...
            //    $('[name="harga_rumah"]').val(data.harga_rumah);
               $('[name="harga_rumah_pindah"]').val(data.harga_rumah);
               $('[name="nomor_va"]').val(data.nomor_va);
               $('[name="nominal_booking"]').val(data.booking_fee_spr);
   ...
   function ganti(id)
   {
       ...
       $.ajax({
           ...
           success: function(data)
           {
               ...
               $('.modal-title').text('Ganti Nama Customer'); // Set title to Bootstrap modal title
